...
public class Main {
    public static void main(String[] args) {
        ...
        Singleton1 singleton1AnotherCopy = Singleton1.INSTANCE;
        ...
        System.out.println(singleton3Copy.hashCode());
        ...
        System.out.print(singleton1Copy.hashCode() + " ");
        System.out.println(singleton1AnotherCopy.hashCode());
